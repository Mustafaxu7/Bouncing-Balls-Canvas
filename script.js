...
let numbballs = 1000;
let balls = [];
let colors = ["green", "blue", "red", "pink", "black", "purple", "silver", "teal", "yellow", "orange", "cyan", "Aqua", "chocolate", "olive", "tan", "DarkSalmon", "peach", "maroon", "gold", "fuchsia", "indigo", "olive", "coral"];
